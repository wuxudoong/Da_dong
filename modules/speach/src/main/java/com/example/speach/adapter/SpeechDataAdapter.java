package com.example.speach.adapter;
...
/**
 * Created by dadong on 2018/5/8.
 */

public class SpeechDataAdapter extends GroupRecyclerAdapter<String, Article> {

    private RequestManager mLoader;

    public SpeechDataAdapter(Context context) {
        super(context);
        mLoader = Glide.with(context.getApplicationContext());
        LinkedHashMap<String, List<Article>> map = new LinkedHashMap<>();
        List<String> titles = new ArrayList<>();
        map.put("精选故事", create(0));
        titles.add("精选故事");
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        return new ArticleViewHolder(mInflater.inflate(R.layout.speech_item_list_article, parent, false));
    }
