...
//        }
    ...
    public static final class Builder {
        ...
        /**
         * 自定义日志文件夹
         * create by ccl 17/10/17
         *
         * @param folderPath
         * @return
         */
        public Builder folderPath(String folderPath) {
            this.customFolderPath = folderPath;
            return this;
        }
        ...
        public CsvFormatStrategy build() {
            ...
            if (logStrategy == null) {
                ...
                String folder = customFolderPath.isEmpty() ? diskPath + File.separatorChar + "logger" : customFolderPath;
